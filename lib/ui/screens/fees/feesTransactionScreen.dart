                        ...
                        child: SizedBox(
                          ...
                          child: Padding(
                            ...
                            child: ListView.builder(
                              ...
                              itemCount: state.feesTransactions.length,
                              itemBuilder: (context, index) {
                                if ((state.moreTransactionsFetchError ||
                                        state
                                            .moreTransactionsFetchInProgress) &&
                                    index ==
                                        state.feesTransactions.length - 1) {
                                  return Column(
                                    children: [
                                      _buildSingleTransactionItem(
                                        transaction:
                                ...
                                return _buildSingleTransactionItem(
                                  transaction: state.feesTransactions[index],
                                );
                              },
                            ),
                          ),
